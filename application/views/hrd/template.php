  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <a href="<?= base_url() ?>auth_hrd/logout" class="btn btn-danger btn-lg" style="margin-top: 15px; margin-right:25px"><b>Logout</b></a>
      </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?= base_url() ?>users"><i class="fa fa-book"></i> <span>Data Pegawai</span></a></li>
        <li><a href="<?= base_url() ?>absensi"><i class="fa fa-calendar"></i> <span>Absensi</span></a></li>        
